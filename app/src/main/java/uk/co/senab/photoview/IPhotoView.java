...
public interface IPhotoView {
    ...
    public static final float DEFAULT_MAX_SCALE = 3.0f; //璁剧疆鑳芥斁澶у埌鏈�ぇ鐨勫�鏁�    public static final float DEFAULT_MID_SCALE = 2.7f; //璁剧疆涓瓑绋嬪害鐨勭缉鏀炬瘮渚�    public static final float DEFAULT_MIN_SCALE = 1.0f;
    public static final int DEFAULT_ZOOM_DURATION = 200; //璁剧疆鍔ㄧ敾鏃堕棿
